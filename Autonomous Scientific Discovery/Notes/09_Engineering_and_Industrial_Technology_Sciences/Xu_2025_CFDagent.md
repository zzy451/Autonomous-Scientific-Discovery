...
- Frozen landing decision: scientific_object_modules=02;09; object_coverage_mode=multi_module; primary_module_for_filing=09; general_method_bucket=none; source_limited=no.
...
- Current PDF/source rule: the authoritative local archived PDF is Reference_PDF\09_Engineering_and_Industrial_Technology_Sciences\Xu_2025_CFDagent.pdf; older pending, abstract-only, no-local-PDF, or stale source_limited=yes wording below is superseded by this harmonization.

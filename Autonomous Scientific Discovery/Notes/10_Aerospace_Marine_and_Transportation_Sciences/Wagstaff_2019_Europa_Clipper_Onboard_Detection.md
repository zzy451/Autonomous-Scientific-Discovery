...
- PDF / 本地文件路径：`Reference_PDF/10_Aerospace_Marine_and_Transportation_Sciences/Wagstaff_2019_Europa_Clipper_Onboard_Detection.pdf`；本地 KDD / author-hosted PDF 已归档（https://wkiri.com/research/papers/wagstaff-onboard-europa-19.pdf）
...
- Source status: locally archived PDF checked at `Reference_PDF/10_Aerospace_Marine_and_Transportation_Sciences/Wagstaff_2019_Europa_Clipper_Onboard_Detection.pdf`; authoritative note state is `source_limited=no`.

...
- canonical_local_pdf: `Reference_PDF/11_Social_Behavioral_Economic_and_Knowledge_System_Sciences/Shah_2026_Automating_Computational_Reproducibility.pdf`
- frozen_source_state: `source_limited=no`
- first_hand_pdf_status: local archived PDF sampled in `Phase6FollowupR20`
- superseded_note_wording: any older source-limited, abstract-only, or "full text still desirable" wording is superseded by this frozen round update
- adjudication_note: preserve the stable computational-reproducibility / `11.07` reading; note location remains filing convenience only

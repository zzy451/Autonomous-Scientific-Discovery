...
- Source checked in this round: arXiv abstract page and PDF text for `2501.03916`.
- Reason: under the current object-coverage rule, the paper's closed-loop auto-research validation is not object-free. It reports concrete formal/computational research tasks and results on ModelNet40 3D classification, CIFAR-100 image classification, SST-2 sentiment classification, and MLE-bench ML-engineering tasks.

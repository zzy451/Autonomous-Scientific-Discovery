...
The queue is already priority-sorted. This round intentionally does **not** attempt to clear all `99` follow-up candidates at once.
...
2. The current top 30 includes:
   ...
   - `23` rows still carrying `source_limited=yes`

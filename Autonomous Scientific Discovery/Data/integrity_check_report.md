...
- `SOURCE_LIMITED` | `ASD-0547` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
- `SOURCE_LIMITED` | `ASD-0553` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
...
- `SOURCE_LIMITED` | `ASD-0617` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
- `SOURCE_LIMITED` | `ASD-0599` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
...
- `SOURCE_LIMITED` | `ASD-0727` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
- `SOURCE_LIMITED` | `ASD-0741` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
- `SOURCE_LIMITED` | `ASD-0768` | Active confirmed-core paper remains source-limited.
  Owner file: `Coverage_Check/multi_module_note_pdf_full_reaudit_progress_451_2026-06-21.md`
...
- `PENDING_SECONDARY` | `ASD-0254 / DCA-000117` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0447 / DCA-000139` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0660 / DCA-000268` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0663 / DCA-000270` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0673 / DCA-000280` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0722 / DCA-000320` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0820 / DCA-000407` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0856 / DCA-000433` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0857 / DCA-000434` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0866 / DCA-000442` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0868 / DCA-000444` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0869 / DCA-000445` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `PENDING_SECONDARY` | `ASD-0870 / DCA-000446` | Discipline code assignment remains pending secondary review: secondary_primary_mismatch.
  Owner file: `Data/discipline_code_assignments.jsonl`
...
- `SECONDARY_TERM_NEEDS_REVIEW` | `01.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `01.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `01.04` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `02.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `02.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `03.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `03.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `03.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `03.04` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `04.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `04.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `04.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `04.04` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `05.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
...
- `SECONDARY_TERM_NEEDS_REVIEW` | `06.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `06.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `06.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `07.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `07.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `07.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `07.04` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `08.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `08.05` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.01` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.02` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.03` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.04` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.05` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
- `SECONDARY_TERM_NEEDS_REVIEW` | `09.06` | Secondary taxonomy term remains provisional (status=needs_review, review_status=unreviewed).
  Owner file: `Data/classification_code_index.json`
...
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0040 / DCA-000033` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0053 / DCA-000043` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0059 / DCA-000049` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0111 / DCA-000076` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0145 / DCA-000103` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0530 / DCA-000173` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
- `NON_DISCIPLINE_GENERAL_METHOD` | `ASD-0541 / DCA-000181` | Record is intentionally kept outside normal discipline shelving as pure general-method-only.
  Owner file: `Data/discipline_code_assignments.jsonl`
